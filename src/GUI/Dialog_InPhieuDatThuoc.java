...
public class Dialog_InPhieuDatThuoc extends JDialog {
	...
	public Dialog_InPhieuDatThuoc(JFrame parent, String maPDH, String maNV, String maKH, String ngayLap, String ngayGiao,
			String trangThaiStr, String phuongThucThanhToanStr, java.util.List<Object[]> chiTietList) {
		super(parent, "Phiếu Đặt Thuốc - " + maPDH, true);
		...
		// Tiêu đề hóa đơn
		JLabel lblTieuDe = new JLabel("HÓA ĐƠN ĐẶT THUỐC");
		...
		panelThongTin.setBorder(BorderFactory.createTitledBorder("Thông Tin Hoá Đơn"));
		...
		JLabel lblMaHD = new JLabel("Mã Phiếu Đặt Thuốc:");
		...
		// Sự kiện nút In
		btnInHoaDon.addActionListener(e -> btnInPhieuDatHangActionPerformed());
...
//		}
	...
	private void btnInPhieuDatHangActionPerformed() {
        ...
        if (printerJob.printDialog()) {
            try {
                printerJob.print();
                JOptionPane.showMessageDialog(this, "In phiếu đặt thuốc thành công!", "Thông Báo", JOptionPane.INFORMATION_MESSAGE);
                isPrinting = true;
                dispose();
            } catch (PrinterException ex) {
                JOptionPane.showMessageDialog(this, "Lỗi khi in phiếu đặt thuốc: " + ex.getMessage(), "Lỗi In", JOptionPane.ERROR_MESSAGE);
                isPrinting = false;
                ex.printStackTrace();
            }
		} else {
