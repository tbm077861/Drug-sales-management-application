...
public class Dialog_InPhieuTraNhapThuoc extends JDialog {
	...
	public Dialog_InPhieuTraNhapThuoc(JFrame parent, String maHoaDon, String maNV, String maNCC, String ngayTra,
			String lyDoTra, java.util.List<Object[]> chiTietList) {
		super(parent, "Phiếu Trả Nhậps Thuốc - " + maHoaDon, true);
		...
		// Sự kiện nút In
		btnInHoaDon.addActionListener(e -> btnInPhieuTraNhapThuocActionPerformed());
...
//		}
	...
	private void btnInPhieuTraNhapThuocActionPerformed() {
		PrinterJob printerJob = PrinterJob.getPrinterJob();
        printerJob.setJobName("Hóa Đơn Trả Nhập Thuốc");
        ...
        if (printerJob.printDialog()) {
            try {
                printerJob.print();
                JOptionPane.showMessageDialog(this, "In phiếu trả nhập thuốc thành công!", "Thông Báo", JOptionPane.INFORMATION_MESSAGE);
                isPrinting = true;
                dispose();
            } catch (PrinterException ex) {
                JOptionPane.showMessageDialog(this, "Lỗi khi in phiếu trả nhập thuốc: " + ex.getMessage(), "Lỗi In", JOptionPane.ERROR_MESSAGE);
                isPrinting = false;
                ex.printStackTrace();
            }
		} else {
