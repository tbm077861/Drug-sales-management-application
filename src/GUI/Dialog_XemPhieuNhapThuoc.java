...
public class Dialog_XemPhieuNhapThuoc extends JDialog {
	...
	public Dialog_XemPhieuNhapThuoc(JFrame parent, String maHoaDon, String ngayLap, String maNV,
		...
		panelThongTin.setLayout(new GridLayout(4, 2, 10, 10));
