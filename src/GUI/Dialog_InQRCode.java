...
public class Dialog_InQRCode extends JDialog {
	...
	public Dialog_InQRCode(Frame parent, String maHD, double tongTien) throws IOException {
		super(parent, "Hóa Đơn - " + maHD, true);
		setSize(481, 611);
